...
if st.button("Generate Schedule"):
    st.info(f"Teams entered: {len(team_rosters_input)} / {num_teams}")
    if len(team_rosters_input) != num_teams:
        st.error("❌ Please fill out all four positions for every team before generating the schedule.")
    else:
